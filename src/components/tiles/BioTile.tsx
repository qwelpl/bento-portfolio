...
const set = (data: TileData, onChange: Props['onChange']) =>
  (key: keyof TileData, val: string) => onChange?.({ ...data, [key]: val })
  ...
  return (
    <div className="p-5 h-full flex flex-col justify-between">
      <div className="flex items-start gap-4">
        {data.avatar && (
          <img src={data.avatar} alt="" className="w-14 h-14 rounded-full object-cover flex-shrink-0" />
        )}
